...
export const CONSENT_NOTICE: string[] = [
  ...
  'When your browser has built-in on-device speech recognition, your speech is transcribed to text entirely on this device. Audio is never sent to any cloud or third-party speech recognition service.',
  'If your browser has no built-in option, you can choose to download a speech recognition model (about 65 MB, one time) that is served from this app itself — not from a third-party service. Only the model files are downloaded; your recording is never uploaded. The model is cached on this device for next time, transcription runs entirely on this device, and you can remove the model from the Privacy and data screen. This is optional: you can decline and record without a transcript.',
